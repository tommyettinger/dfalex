...
public class DfaAuxiliaryInformation<MATCHRESULT>
{
    ...
    public synchronized List<DfaState<MATCHRESULT>> getStatesByNumber()
    {
        ...
        {
            final List<DfaState<MATCHRESULT>> statesByNumber = new ArrayList<>();
            final LinkedList<DfaState<MATCHRESULT>> q = new LinkedList<>();
            ...
            while (!q.isEmpty())
            {
                ...
                state.enumerateTransitions(new DfaTransitionConsumer<MATCHRESULT>() { public void acceptTransition(char in, char out, DfaState<MATCHRESULT> target) {    
    ...
    public void depthFirstSearch(
            ObjObjToVoid<DfaState<MATCHRESULT>, DfaState<MATCHRESULT>> onEnter,
            ObjObjToVoid<DfaState<MATCHRESULT>, DfaState<MATCHRESULT>> onSkip,
            ObjObjToVoid<DfaState<MATCHRESULT>, DfaState<MATCHRESULT>> onLeave)
    {
    ...
    public synchronized int[] getCycleNumbers()
    {
        ...
        ObjObjToVoid<DfaState<MATCHRESULT>, DfaState<MATCHRESULT>> onEnter = new ObjObjToVoid<DfaState<MATCHRESULT>, DfaState<MATCHRESULT>>() {
            @Override
            public void accept(DfaState<MATCHRESULT> parent, DfaState<MATCHRESULT> child) {
                stack.push(child);
                backLink[child.getStateNumber()] = orderIndex[child.getStateNumber()] = pindex[0]++;
            }
        };
        ObjObjToVoid<DfaState<MATCHRESULT>, DfaState<MATCHRESULT>> onSkip = new ObjObjToVoid<DfaState<MATCHRESULT>, DfaState<MATCHRESULT>>() {
            @Override
            public void accept(DfaState<MATCHRESULT> parent, DfaState<MATCHRESULT> child) {
        ...
        ObjObjToVoid<DfaState<MATCHRESULT>, DfaState<MATCHRESULT>> onExit = new ObjObjToVoid<DfaState<MATCHRESULT>, DfaState<MATCHRESULT>>() {
            @Override
            public void accept(DfaState<MATCHRESULT> parent, DfaState<MATCHRESULT> child) {
                final int childi = child.getStateNumber();
    ...
    public synchronized List<MATCHRESULT> getDestinies()
    {
        ...
        ObjObjToVoid<DfaState<MATCHRESULT>, DfaState<MATCHRESULT>> onMerge = new ObjObjToVoid<DfaState<MATCHRESULT>, DfaState<MATCHRESULT>>() {
            @Override
            public void accept(DfaState<MATCHRESULT> parent, DfaState<MATCHRESULT> child) {
