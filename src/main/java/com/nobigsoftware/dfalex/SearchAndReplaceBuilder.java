...
public class SearchAndReplaceBuilder
{
     ...
     */
    public ObjToObj<String,String> buildStringReplacer()
    {
        if (m_dfaMemo == null)
        {
            m_dfaMemo = m_dfaBuilder.build(ambiguityResolver);
        }
        ...
        return new ObjToObj<String, String>(){
            public String apply(String str) {
                return searcher.findAndReplace(str, replacer);
            }
        };
    }
     ...
     * @return The search+replace function
     */
    public static <MR> ObjToObj<String,String> buildFromSearcher(final StringSearcher<MR> searcher, final ReplacementSelector<? super MR> replacer)
    {
        return new ObjToObj<String, String>() {
            public String apply(String str) {
                return searcher.findAndReplace(str, replacer);
    ...
    private static DfaAmbiguityResolver<Integer> ambiguityResolver = new DfaAmbiguityResolver<Integer>() {
        @Override
        public Integer apply(Set<Integer> candidates) {
                Integer ret = null;
